 ...
 * Copyright (c) 2009-2011 by appsample, Inc. All Rights Reserved.
...
//@interface appsampleObject : NSObject
//@end

@interface appsampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[appsampleObject class]])
		{
			for (NSString *key in [[(appsampleObject*)o modules] allKeys])
			{
