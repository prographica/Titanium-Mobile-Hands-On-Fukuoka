...
// in simulator we redefine to format for appsample Developer console
...
{\
	NSString * exceptionName = [@"org.appsample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.appsample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIappsampleNativeItemNone = -1, 
	UIappsampleNativeItemSpinner = -2,
	UIappsampleNativeItemProgressBar = -3,
	
	UIappsampleNativeItemSlider = -4,
	UIappsampleNativeItemSwitch = -5,
	UIappsampleNativeItemMultiButton = -6,
	UIappsampleNativeItemSegmented = -7,
	
	UIappsampleNativeItemTextView = -8,
	UIappsampleNativeItemTextField = -9,
	UIappsampleNativeItemSearchBar = -10,
	
	UIappsampleNativeItemPicker = -11,
	UIappsampleNativeItemDatePicker = -12,
	
	UIappsampleNativeItemInfoLight = -13,
	UIappsampleNativeItemInfoDark = -14,
	
	UIappsampleNativeItemDisclosure = -15,
	
	UIappsampleNativeItemContactAdd = -16
};
